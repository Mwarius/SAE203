...
<header>
    <div class='p-5 bg-secondary text-white'>
        <div><h1 class='text-center'>Bienvenue sur l'intranet de GMG Construction</h1></div>
    </div>
    <div>
                ...
                <div class='collapse navbar-collapse' id='navbarNav'>
                    ...
                    <div class='d-flex align-items-center'>";
                        if (isset($_SESSION['nom']) && isset($_SESSION['role'])) {
                            echo "<span class='text-light me-2'>Connecté en tant que " . htmlspecialchars($_SESSION['nom']) . " (" . htmlspecialchars($_SESSION['role']) . ")</span>";
...
?>
<!-- else { 
echo "<span class='text-light me-2'>Vous n'êtes pas connecté</span>";
echo "<a class='btn btn-primary btn-sm' href='./portail_connexion.php'>Connexion</a>";
} -->